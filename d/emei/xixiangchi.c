...
//	if (me->query_skill("beauty",1) > me->query("max_pot")-100){
//		tell_object(me, "你也太臭美了吧，天天洗澡不练功！\n");
//		return 1;
//	}
      ...
      if (me->query("gender") != "女性"
        && (dir == "north")) {
                if (objectp(present("hou zi", environment(me))))
                        return notify_fail("一只猴子在你面前唧唧喳喳的叫着。\n");
