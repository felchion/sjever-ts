...
int ask_fuwei()
{
	...
	|| me->query("marry")){		
		...
		me->set("quest/pixie/start",1);
		log_file("quest/pixie",sprintf("%-18s想开解葵花宝典花费解迷机会一次。\n",
...
int ask_yuantu()
{
	if (this_player()->query("quest/pixie/start")) {
...
int ask_pixie()
{
	...
	if(this_player()->query_condition("killer")){		
		command("say 命案在身，还敢窥视我们林家的辟邪剑谱？");
