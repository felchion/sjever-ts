...
void create()
{
	set("short", "树林深处");
	set("long",@LONG
这是一片小树林的深处。地面上绿草如荫，茂密地生长着。四周安静得令
人毛骨悚然，看来还是赶紧离开这里为妙。树丛中有一棵老树(tree)，相对于
其它树显得十分的粗壮，树上的树叶(leaf)非常茂密，有几只不知名的小鸟在
其中窜来窜去。
LONG
);
	set("exits",([
...
int do_sling(string arg)
{
	...
	object me = this_player();
	int i, qi, level, jinglicost, temp;
	string weapon_name;
