...
int do_yanjiu(string arg)
{
	...
	if(me->query(QUESTDIR5+"combat_exp")
	&& me->query("combat_exp")+me->query("re_gift")*5000000-me->query(QUESTDIR5+"combat_exp")<500000)
	...
	if(me->query_temp(QUESTDIR5+"yanjiu")>6)
	{
		...
		me->set(QUESTDIR5+"combat_exp",me->query("combat_exp")+me->query("re_gift")*5000000);
