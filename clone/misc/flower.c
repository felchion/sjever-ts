...
#define flower_path "/d/city/npc/obj/flower/"
void create()
{
...
////////////////////////////////////////////////////////////////		 
		 ...
		 //蓝色妖姬
			if(flowers[0]["flower_id"]=="lanse yaoji")
		 {
			 ob=new(flower_path+"blue_rose");
			 ob->set_amount(flowers[0]["amount"]);
		 }
		 //白玫瑰
		 ...
		 //粉玫瑰
			if(flowers[0]["flower_id"]=="pink meigui")
		 {
			 ob=new(flower_path+"pink_rose");
			 ob->set_amount(flowers[0]["amount"]);
		 }
 		 //红玫瑰
...
///////////////////////////////////////////////////////////////
	...
	tell_object(me,CYN"\n一个卖花的小姑娘脚步蹒跚的跟着你走了过来。\n");
        tell_object(me,"卖花姑娘走到你跟前欠身说道：“这里有您的花，是"+flowers[0]["from"]+"托我送给您的”。\n");
        tell_object(me,"卖花姑娘从花篮中拿出一束"+flowers[0]["flowername"]+CYN+"交到你手里”。\n");
        tell_object(me,"卖花姑娘对你微微一笑道：“花已经送到，小女告退，后会有期！”。\n");
