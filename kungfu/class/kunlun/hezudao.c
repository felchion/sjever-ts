...
void create()
{
  ...
  set("inquiry", (["焦尾琴" : (: ask_qin :)]));

	set_skill("art", 300);
	set_skill("literate", 520);
	set_skill("force", 500);
	set_skill("xuantian-wuji", 480);
	set_skill("dodge", 500);
	set_skill("taxue-wuhen", 470);
	set_skill("xunlei-jian", 470);
	set_skill("strike", 500);
	set_skill("kunlun-zhang", 470);
	set_skill("parry", 500);
	set_skill("sword", 500);
	set_skill("liangyi-jian", 480);
	set_skill("throwing", 500);
  set_skill("chuanyun-tui", 470);
  set_skill("leg", 490);
  set_skill("zhentian-quan", 480);
  set_skill("cuff", 500);
  set_skill("mantian-huayu", 470);
