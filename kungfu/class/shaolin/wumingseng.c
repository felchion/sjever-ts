...
void create()
{
	...
	set_skill("club", 500);
	set_skill("blade", 500);
	set_skill("ranmu-daofa", 530);
	set_skill("finger", 500);
	set_skill("strike", 500);
	set_skill("buddhism", 300);
	set_skill("riyue-bian", 530);
	set_skill("whip", 500);
	set_skill("yizhi-chan", 530);
	set_skill("literate",550);
	set_skill("jingang-quan", 530);
	set_skill("hand", 500);
	set_skill("leg", 500);
	set_skill("ruying-suixingtui", 530);
	set_skill("banruo-zhang", 530);
	set_skill("qianye-shou", 520);
	set_skill("longzhua-gong", 520);
	set_skill("weituo-chu", 530);
	set_skill("zui-gun", 520);
	set_skill("club", 500);
	set_skill("nianhua-zhi",520);
...
int accept_object(object who, object ob)
{
	...
	if (!(my_fam) || my_fam["family_name"] !="少林派"
	 || my_fam["generation"] != 36 || who->query_skill("yijin-jing",1) <140
