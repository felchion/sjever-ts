...
"冯","卫","蒋","沈","韩","杨","朱","秦","尤","许","何","吕","施"});
string *first_name_id = ({ "zhao","qian","sun","li","zhou","wu","zheng","wang","zhang","chen", "liu","lin",
"feng","wei","jiang","shen","han","yang","zhu","qin","you","xu","he","lu","shi" });
...
void create()
{
	...
	set_skill("hanbing-zhenqi", 20*i);
	set_skill("dodge", 20*i);
	set_skill("zhongyuefeng", 20*i);
	set_skill("hand", 20*i);
	set_skill("songyang-shou", 20*i);
