...
mapping *action = ({
	([      
		"action" : "$N身躯微欠，中宫一掌缓缓拍出，光明正大，是此套掌法的起首式「大嵩阳」",
		"damage_type" : "瘀伤",
		"lvl" : 0,
		"skill_name" : "大嵩阳"
	]),
	...
	([      
		"action" : "$N大喝一声，使出一路大嵩阳掌法中的「铁梁道」，双掌上下翻飞、大开大阖，连续击向$n",
		"damage_type" : "瘀伤",
		"lvl" : 30,
		"skill_name" : "铁梁道"
	]),
	...
	([      
		"action" : "$N运起丹田之气猛喝一声，一式「观胜峰」，右掌挟带着狂风，向前斜推，掌势如劈山排云般压向$n",
		"lvl" : 70,
		"skill_name" : "观胜峰",
		"damage_type" : "瘀伤"
	]),
...
int valid_learn(object me)
{
	...
	return notify_fail("练大嵩阳神掌必须空手。\n");
	if ((int)me->query_skill("hanbing-zhenqi", 1) < 20)
	return notify_fail("你的寒冰真气火候不够，无法学大嵩阳神掌。\n");
	if ((int)me->query("max_neili") < 100)
	return notify_fail("你的内力太弱，无法练大嵩阳神掌。\n");
	return 1;
}
...
int practice_skill(object me)
{
	...
	return notify_fail("你的内力不够练大嵩阳神掌。\n");
...
{
	return __DIR__"ss/songyang-zhang/" + action;
}