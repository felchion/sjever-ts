...
int exert(object me, object target)
{
	...
	if((int)me->query_skill("jiuyang-shengong", 1) < 100 )
		return notify_fail("你的九阳神功等级不够，还不能传功给别人。\n");
	...
	if(! target->query_skill("jiuyang-shengong", 1))
	...
	call_out("remove_effect", skill*6, target, me->query("id"));
	me->start_busy(4);
	return 1;
}
