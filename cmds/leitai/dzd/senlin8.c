...
LONG
	...
	set("exits",([
		...
		"northwest" : __DIR__"senlin10",
		"southwest" : __DIR__"mudi",
	]));
	setup();
}
...
void init()
{
	...
	if(!room = find_object(__DIR__"shuding4"))
		room = load_object(__DIR__"shuding4");
...
int valid_leave(object me,string dir)
{
	...
	if(valid && !wizardp(me) && room = find_object(__DIR__"shuding4"))
