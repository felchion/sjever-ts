...
RED"干将" : ([	"id": "ganjiang",
		...
		"weapon_prop":         ([ "damage":300 ]),//180
		"sharpness":	       10,
		"rigidity":	       9,
		]),
RED"莫邪" : ([	"id": "moye",
		"long2"	: RED"莫邪锋利无比，能开天辟地，荡妖除魔！\n"NOR,
		"weapon_prop":         ([ "damage":160, "kill": 15 ]),//130
		"sharpness":	       15,
		"rigidity":	       9,
		]),
RED"鱼肠" : ([	"id": "yuchang",
		"long2"	: RED"鱼肠轻巧无比，能开天辟地，荡妖除魔！\n"NOR,
		"weapon_prop":         ([ "damage":180 , "pfm_attack":180 ]),//100
		"sharpness":	       8,
		"rigidity":	       7,
		]),
//RED"太阿" : ([	"id": "taie",
//		"long2"	: RED"太阿帝王之兵，持之能号令天下，莫有不从！\n"NOR,
//		"weapon_prop":         ([ "damage":270 , "auto_heal":25]),//100
//		"sharpness":	       7,
//		"rigidity":	       9,
//		]),
RED"巨阙" : ([	"id": "juque",
		"long2"	: RED"巨阙坚硬无比，能开天辟地，荡妖除魔！\n"NOR,
		"weapon_prop":         ([ "damage":220, "pfm_dodge":300 ]),//120
		"sharpness":	       7,
		"rigidity":	       20,
		]),
//RED"纯钩" : ([	"id": "chungou",
//		"long2"	: RED"纯钩将帅之兵，持之能挥军百万，克敌制胜！\n"NOR,
//		"weapon_prop":         ([ "damage":270 , "auto_charge":25 ]),//120
//		"sharpness":	       7,
//		"rigidity":	       8,
//		]),
RED"湛卢" : ([	"id": "zhanlu",
		"long2"	: RED"湛卢威力、锋利、坚硬都冠绝当世，乃千古神兵！\n"NOR,
		"weapon_prop":         ([ "damage":220 , "pfm_parry":300]),//160
		"sharpness":	       12,
		"rigidity":	       12,
		]),
RED"胜邪" : ([	"id": "shengxie",
		"long2"	: RED"胜邪宝剑，威力巨大且有聚气效果！\n"NOR,
		"weapon_prop":         ([ "damage":160 , "ap":120]),//160
		"sharpness":	       10,
		"rigidity":	       9,
		]),
RED"工布" : ([	"id": "gongbu",
		"long2"	: RED"工布天生怪异，功能参商！\n"NOR,
		"weapon_prop":         ([ "damage":180 ,"rush": 20  ]),//70
		"sharpness":	       10,
		"rigidity":	       9,
		]),
RED"龙泉" : ([	"id": "longquan",
		"long2"	: RED"龙泉人间极品，武林至宝！\n"NOR,
		"weapon_prop":         ([ "damage":160 , "dex":5 , "str":5 , "con":5 , "int":5 ]),
		"sharpness":	       9,
		"rigidity":	       7,
		]),
]);
...
static mapping	Armor_Special_Class =	([
	"cap":	([
		...
		RED"龙泉头盔"NOR : ([
			"id":		"longquan toukui",
			"long2":	RED"龙泉人间极品，武林至宝！\n"NOR,
			"armor_prop":	([ "armor":25 , "dex":1 , "str":1 , "con":1 , "int":1 ]),
			]),
		]),
	"glove": ([
		HIB"飞叶手套"NOR : ([
	...
	"boot": ([
		...
		HIR"工布靴"NOR : ([
			"id":		"gongbu xue",
			"long2":	RED"工布天生怪异，功能参商！\n"NOR,
			"armor_prop":	([ "armor":25 , "pfm_dodge":20 , "pfm_parry":20 ]),
			]),
		RED"胜邪靴"NOR : ([
			"id":		"shengxie xue",
	...
	"belt": ([
		HIW"飞天腰带"NOR : ([
			...
			"armor_prop":	([ "armor":25 , "dex":2 ]),
			]),
		HIB"辟邪腰带"NOR : ([
			"id":		"pixie yaodai",
			"long2":	HIB"辟邪除魔之震妖宝器！\n"NOR,
			"armor_prop":	([ "armor":25 , "con":2 ]),
			]),
		RED"湛卢腰带"NOR : ([
			"id":		"zhanlu yaodai",
	...
	"coat": ([
		...
		RED"工布彩衣"NOR : ([
			"id":		"gongbu caiyi",
			"long2":	RED"工布天生怪异，功能参商！\n"NOR,
			"armor_prop":	([ "armor":90 , "pfm_parry":35 , "pfm_dodge":35 ]),
			]),
		RED"胜邪彩衣"NOR : ([
			"id":		"shengxie caiyi",
		...
		RED"龙泉彩衣"NOR : ([
			"id":		"longquan caiyi",
			"long2":	RED"龙泉人间极品，武林至宝！\n"NOR,
			"armor_prop":	([ "armor":80 , "dex":1 , "str":1 , "con":1 , "int":1 ]),
			]),
		]),
	"armor": ([
		RED"莫邪甲胄"NOR : ([
		...
		RED"工布甲胄"NOR : ([
			"id":		"gongbu jiazhou",
			"long2":	RED"工布天生怪异，功能参商！\n"NOR,
			"armor_prop":	([ "armor":108 , "pfm_parry":30 , "pfm_dodge":30 ]),
			]),
		RED"胜邪甲胄"NOR : ([
			"id":		"shengxie jiazhou",
			"long2":	RED"胜邪无比坚固巨大而无任何要求！\n"NOR,
		...
		RED"龙泉甲胄"NOR : ([
			"id":		"longquan jiazhou",
			"long2":	RED"龙泉人间极品，武林至宝！\n"NOR,
			"armor_prop":	([ "armor":100 , "dex":1 , "str":1 , "con":1 , "int":1 ]),
			]),
		]),
	"mantle": ([
		RED"莫邪披风"NOR : ([
		...
		RED"工布披风"NOR : ([
			"id":		"gongbu pifeng",
			"long2":	RED"工布天生怪异，功能参商！\n"NOR,
			"armor_prop":	([ "armor":70 , "pfm_parry":20 , "pfm_dodge":20 ]),
			]),
		RED"胜邪披风"NOR : ([
			"id":		"shengxie pifeng",
			"long2":	RED"胜邪无比坚固巨大而无任何要求！\n"NOR,
		...
		RED"龙泉披风"NOR : ([
			"id":		"longquan pifeng",
			"long2":	RED"龙泉人间极品，武林至宝！\n"NOR,
			"armor_prop":	([ "armor":60 , "dex":1 , "str":1 , "con":1 , "int":1 ]),
			]),
		]),
]);
...
static mapping	Armor_Super_Class = ([
	...
	HIR"神通" : ([	"id":	"shentong",
			"long2":	HIR"天器神通，走势要平善，气要随行，两眼顾尖，气沉两足稳，
身法需自然，身行如飞燕，身落如停风，收如花絮，刺如钢钉！\n"NOR,
		]),
	HIG"无极" : ([	"id":	"wuji",
			"long2": HIG"此物已达出神入化，登峰造极，神乎其神之境界！俗说万物归宗，便是这“无极”！\n"NOR,
	...
	HIY"乾坤" : ([	"id":	"qiankun",
			"long2": HIY"此物左右两边分别以黑白两种物质融会而成，一黑一白，切合乾坤，包含阴阳之气，好一见宝物！\n"NOR,
		]),
	HIY"太极" : ([	"id":	"taiji",
			"long2": HIY"太极者，无极而生，阴阳之母也。动之则分，静之则合。无过不及，随曲就伸。
人刚我柔谓之走，我顺人背谓之粘。动急则急应，动缓则缓随。虽变化万端，而
