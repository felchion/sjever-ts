...
#define SITE_MUL		140	 //站点成长百分比
#define VIP_MUL		  100	//贵宾玩家和普通玩家的增长速度控制
#define VIP_LINGWU_MUL	  100   //贵宾玩家和普通玩家的领悟速度控制
#define VIP_LEARN_MUL	  100   //贵宾玩家和普通玩家的学习速度控制
#define VIP_STUDY_MUL	  100   //贵宾玩家和普通玩家的读书速度控制
#define ROBOT_MUL	50	 //ROBOT玩家的成长速度

#define SL_LINGWU_MUL	  65   //少林领悟
#define MR_LINGWU_MUL	  80   //慕容领悟
#define LEARN_MUL	  50   //学习速度
#define STUDY_MUL	  50   //读书速度
...
#define GBWU_JOB_MUL      30	//丐帮吴长老杀人任务            gifted    joblist:丐帮                     /adm/daemons/taskd.c
																									// /kungfu/gaibang/wu.c
...
#define SS_JOB_MUL        30	//嵩山任务			gifted					/adm/daemons/taskd.c    taskd 统一计算， 实际变化为GBWU_JOB_MUL
...
#define HS_JOB_MUL        60   //华山任务               gifted    joblist:华山                  /d/huashan/npc/yuebuqun.c


#define TDH_JOB_MUL       60	//天地会任务  /clone/npc/tdh/man1.h
...
/*公众任务(团队)*/
#define HUBIAO_JOB_MUL    180   //护镖任务            gifted   joblist:护镖            /d/fuzhou/hubiao/obj/cart.c /d/fuzhou/hubiao/hubiao.h
