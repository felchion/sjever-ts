...
RED"工布" : ([	"id": ({ "gongbu jian", "gongbu", "sword", "jian" }),
		...
		"weapon_prop/damage":  150,
		"weapon_prop/pfm_attack":  100,
		"weapon_prop/pfm_parry":   100,
		"weapon_prop/pfm_dodge":   100,
		"sharpness":	       10,
		"rigidity":	       9,
		]),
...
void special_weapon_status(int i)
{
	...
	switch(i){
		case 0:	special_st += ({ HIG"长生" });
			name_st	+= ({ "增加大量气血" });
			mp["weapon_prop/qi"] = 2500 + random(2500);
			break;
		case 3:	special_st += ({ HIG"长生" });
			name_st	+= ({ "增加很多气血" });
			mp["weapon_prop/qi"] = 1500 + random(1000);
			break;
		case 6:	special_st += ({ HIG"长生" });
			name_st	+= ({ "增加气血" });
			mp["weapon_prop/qi"] = 1000 + random(500);
			break;
		case 9:	special_st += ({ RED"噬魂" });
			name_st	+= ({ "极品必杀" });
			mp["weapon_prop/kill"] = 11+random(10);
			break;
		case 12: special_st += ({ RED"噬魂" });
			name_st	+= ({ "超高必杀" });
			mp["weapon_prop/kill"] = 6+random(5);
			break;
		case 15: special_st += ({ RED"噬魂" });
			name_st	+= ({ "提高必杀" });
			mp["weapon_prop/kill"] = 1+random(5);
			break;
		case 18: special_st += ({ RED"噬血" });
			name_st	+= ({ "极品爆击" });
			mp["weapon_prop/rush"] = 11+random(10);
			break;
		case 21: special_st += ({ RED"噬血" });
			name_st	+= ({ "超高爆击" });
			mp["weapon_prop/rush"] = 6+random(5);
			break;
		case 24: special_st += ({ HIG"小周天" });
			name_st	+= ({ "增加大量精力" });
			mp["weapon_prop/jingli"] = 2500	+ random(2500);
			break;
		case 27: special_st += ({ HIG"小周天" });
			name_st	+= ({ "增加很多精力" });
			mp["weapon_prop/jingli"] = 1500 + random(1000);
			break;
		case 30: special_st += ({ HIG"小周天" });
			name_st	+= ({ "增加精力" });
			mp["weapon_prop/jingli"] = 1000 + random(500);
			break;
		case 33: special_st += ({ HIG"小周天" });
			name_st	+= ({ "增加少量精力" });
			mp["weapon_prop/jingli"] = 500 + random(500);
			break;
		case 36: special_st += ({ HIG"大周天" });
			name_st	+= ({ "增加大量内力" });
			mp["weapon_prop/neili"]	= 2500 + random(2500);
			break;
		case 39: special_st += ({ HIG"大周天" });
			name_st	+= ({ "增加很多内力" });
			mp["weapon_prop/neili"]	= 1500 +	random(1000);
			break;
		case 42: special_st += ({ HIG"大周天" });
			name_st	+= ({ "增加内力" });
			mp["weapon_prop/neili"]	= 1000 +	random(500);
			break;
		case 45: special_st += ({ HIG"大周天" });
			name_st	+= ({ "增加少量内力" });
			mp["weapon_prop/neili"]	= 500 +	random(500);
			break;
		case 48: special_st += ({ HIR"绝世" });
			name_st	+= ({ "绝世威力" });
			mp["weapon_prop/damage"] += (30+random(mp["weapon_prop/damage"]) * 3);
			break;
		case 51: special_st += ({ HIR"旷世" });
			name_st	+= ({ "旷世威力" });
			mp["weapon_prop/damage"] += (20+random(mp["weapon_prop/damage"]) * 2);
			break;
		case 54: special_st += ({ HIW"灭世" });
			name_st	+= ({ "提升威力" });
			mp["weapon_prop/damage"] += (10+random(mp["weapon_prop/damage"]));
			break;
		...
		case 60: special_st += ({ HIC"上品" });
			name_st	+= ({ "提高威力" });
			mp["weapon_prop/damage"] += (5 + random(mp["weapon_prop/damage"]/2));
			break;
		case 63: special_st += ({ HIC"优良" });
			name_st	+= ({ "加强威力" });
			mp["weapon_prop/damage"] += mp["weapon_prop/damage"]/4;
			break;
		case 66: special_st += ({ HIR"饮血" });
			name_st	+= ({ "极品爆击" });
			mp["weapon_prop/super"] = 11+random(10);;
			break;
		case 69: special_st += ({ HIR"饮血" });
			name_st	+= ({ "极品爆击" });
			mp["weapon_prop/super"] = 6+random(5);;
			break;
		case 72: special_st += ({ HIR"饮血" });
			name_st	+= ({ "极品爆击" });
			mp["weapon_prop/super"] = 1+random(5);;
			break;
		case 87: special_st +=	({ BLU"冥石" });
			name_st	+= ({ "极品躲避" });
			mp["weapon_prop/pfm_dodge"]	+= (70	+ random(70));
		...
		case 127: special_st +=	({ HIW"闪电" });
			name_st	+= ({ "极品命中" });
			mp["weapon_prop/pfm_attack"] += (100 + random(100));
			break;
		case 130: special_st +=	({ HIB"飓电" });
			name_st	+= ({ "超高命中" });
			mp["weapon_prop/pfm_attack"] += (70	+ random(70));
			break;
		case 133: special_st +=	({ HIM"紫电" });
			name_st	+= ({ "提高命中" });
			mp["weapon_prop/pfm_attack"] += (40	+ random(40));
			break;
		case 136: special_st +=	({ HIW"雷电" });
			name_st	+= ({ "提升命中" });
			mp["weapon_prop/pfm_attack"] += (20	+ random(20));
			break;
		case 139: special_st +=	({ WHT"天灵" });
			name_st	+= ({ "极品思维" });
			mp["weapon_prop/int"] += (5 +	random(5));
			break;
		case 142: special_st +=	({ WHT"地灵" });
			name_st	+= ({ "增加思维" });
			mp["weapon_prop/int"] += (3 +	random(4));
			break;
		case 145: special_st +=	({ WHT"人灵" });
			name_st	+= ({ "提高悟性" });
			mp["weapon_prop/int"] += (2 + random(3));
			break;
		case 148: special_st +=	({ WHT"合灵" });
			name_st	+= ({ "增加悟性" });
			mp["weapon_prop/int"] += (1 + random(2));
			break;
		case 151: special_st +=	({ BLU"天玄" });
			name_st	+= ({ "极品根骨" });
			mp["weapon_prop/con"] += (5 +	random(5));
			break;
		case 154: special_st +=	({ BLU"地玄" });
			name_st	+= ({ "增加根骨" });
			mp["weapon_prop/con"] += (3 +	random(4));
			break;
		case 157: special_st +=	({ BLU"人玄" });
			name_st	+= ({ "提高体魄" });
			mp["weapon_prop/con"] += (2 + random(3));
			break;
		case 160: special_st +=	({ BLU"合玄" });
			name_st	+= ({ "增加体魄" });
			mp["weapon_prop/con"] += (1 + random(2));
			break;
		case 163: special_st +=	({ HIM"天宇" });
			name_st	+= ({ "极品力量" });
			mp["weapon_prop/str"] += (5 + random(5));
			break;
		case 166: special_st +=	({ HIM"地宇" });
			name_st	+= ({ "增加力量" });
			mp["weapon_prop/str"] += (3 + random(4));
			break;
		case 169: special_st +=	({ HIM"人宇" });
			name_st	+= ({ "提高膂力" });
			mp["weapon_prop/str"] += (2 + random(3));
			break;
		case 172: special_st +=	({ HIM"合宇" });
			name_st	+= ({ "增加膂力" });
			mp["weapon_prop/str"] += (1 + random(2));
			break;
		case 175: special_st +=	({ MAG"天渊" });
			name_st	+= ({ "极品速度" });
			mp["weapon_prop/dex"] += (5 + random(5));
			break;
		case 178: special_st +=	({ MAG"地渊" });
			name_st	+= ({ "增加速度" });
			mp["weapon_prop/dex"] += (3 + random(4));
			break;
		case 181: special_st +=	({ MAG"人渊" });
			name_st	+= ({ "增加身法" });
			mp["weapon_prop/dex"] += (2 + random(3));
			break;
		case 184: special_st +=	({ MAG"合渊" });
			name_st	+= ({ "增加身法" });
			mp["weapon_prop/dex"] += (1 + random(2));
			break;
		...
		case 190: special_st +=	({ GRN"斑竹" });
			...
			mp["material"] = "bamboo";
			break;
		case 193: special_st += ({ RED"噬血" });
			name_st	+= ({ "提高爆击" });
			mp["weapon_prop/rush"] = 1+random(5);
			break;
		case 195: special_st +=	({ HIW"耀石" });
			name_st	+= ({ "极品防御" });
			mp["weapon_prop/pfm_parry"]	+= (100	+ random(100));
			break;
		case 199: special_st +=	({ HIB"剧毒" });
			name_st	+= ({ "毒性攻击" });
			mp["poisoned"] = "xx_poison";
			mp["poison_number"] = 1000;
			break;
		...
		case 235: special_st +=	({ HIG"周天" });
			name_st	+= ({ "增加内力和精力" });
			mp["weapon_prop/neili"]	= 1000 +	random(1000);
			mp["weapon_prop/neili"]	= 1000 +	random(1000);
		case 238: special_st +=	({ HIY"大洐" });
			name_st	+= ({ "提高所有属性" });
			mp["weapon_prop/dex"] += 8; 
			mp["weapon_prop/str"] += 8; 
			mp["weapon_prop/con"] += 8; 
			mp["weapon_prop/int"] += 8; 
			break;
		case 241: special_st +=	({ HIY"三才" });
			name_st	+= ({ "增加所有属性" });
			mp["weapon_prop/dex"] += 5; 
			mp["weapon_prop/str"] += 5; 
			mp["weapon_prop/con"] += 5; 
			mp["weapon_prop/int"] += 5; 
			break;
		case 244: special_st +=	({ HIW"白石" });
			name_st	+= ({ "超高防御" });
			mp["weapon_prop/pfm_parry"]	+= (70	+ random(70));
			break;
		case 247: special_st +=	({ HIM"紫石" });
			name_st	+= ({ "提高防御" });
			mp["weapon_prop/pfm_parry"]	+= (40	+ random(40));
			break;
		case 250: special_st +=	({ HIY"黄石" });
			name_st	+= ({ "提升防御" });
			mp["weapon_prop/pfm_parry"]	+= (20	+ random(20));
			break;
		...
		case 256: special_st +=	({ HIB"蓝石" });
			name_st	+= ({ "提高躲避" });
			mp["weapon_prop/pfm_dodge"]	+= (40	+ random(40));
			break;
		case 259: special_st +=	({ HIR"红石" });
			name_st	+= ({ "提升躲避" });
			mp["weapon_prop/pfm_dodge"]	+= (20	+ random(20));
			break;
		...
		case 265: special_st +=	({ HIW"水火" });
			name_st	+= ({ "提高命中和威力" });
			mp["weapon_prop/pfm_attack"] += (40	+ random(40));
			mp["weapon_prop/pfm_damage"] += (20	+ random(40));
			break;
		...
		case 274: special_st +=	({ HIG"木水" });
			name_st	+= ({ "提高躲避和命中" });
			mp["weapon_prop/pfm_attack"] += (40	+ random(40));
			mp["weapon_prop/pfm_dodge"]	+= (20	+ random(40));
			break;
		case 277: special_st +=	({ HIG"长寿" });
			name_st	+= ({ "增加气血和精血" });
			mp["weapon_prop/qi"]	= 1000 +	random(500);
			mp["weapon_prop/jing"]	= 1000 +	random(500);
		default: break;
	}
