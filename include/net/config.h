...
// The TMI-2
#define MUDLIST_DNS ({ "192.168.1.6", 6670 })
// The Eastern Stories
#define MUDLIST_BAK ({ "192.168.1.6", 7781 })

#define LISTNODES (["ts2":"192.168.1.6 7781","ts":"192.168.1.6 6670","cp":"192.168.1.6 6671"])

#define NAT_MAP ([])
// \
//	"cp"	:	({"ts.sjever.net 6667"}),\
//	"ts"	:	({"ts.sjever.net 6666"}),\
//	"ts2"	:	({"ts2.sjever.net 7777"}),\)
