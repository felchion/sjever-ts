...
static string u_weapon="";
static string nw_parry="";
static string w_parry="";
static string u_liumai="";
static string* u_ub_pfm=({});									//非战斗状态的pfm
static string* u_f_pfm=({});
static string* u_w_pfm=({});
static string* u_pfm=({});										//初试化武器，空手招架，武器招架，pfm列表				
static string* skill;	                                                                   //skill 列表	
static int in_level;
static string u_menpai="";
static string *in_menpai;
static mapping pmap;											//prepare的武功				
static string *str_liumai =({"shaoze","guanchong","shangyang","shaochong","zhongchong","shaoshang"});
static int in_weapon;
